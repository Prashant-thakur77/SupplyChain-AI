...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    return NextResponse.json(await agentClient.post("/warroom", { supply_chain_id: twin.supply_chain_id, user_id: b.userId ?? (await getSessionUser())?.id ?? "anonymous", twin, scenarios: b.scenarios ?? [], use_presets: b.usePresets ?? true }))
