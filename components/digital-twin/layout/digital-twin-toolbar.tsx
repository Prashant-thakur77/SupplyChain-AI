    ...
    <>
      <div className="w-full h-auto sm:h-14 py-3 sm:py-0 bg-theme-bg-surface border-b border-theme-border-subtle flex flex-col sm:flex-row items-center justify-between gap-3 px-4 sm:px-6 z-30 flex-shrink-0">
        ...
        <div className="flex items-center justify-between sm:justify-start w-full sm:w-auto gap-6">
          ...
          <div className="flex items-center bg-[#F1F5F9] dark:bg-[#191817] p-1 rounded-full border border-theme-border-subtle">
            <button
        ...
        <div className="flex items-center justify-between sm:justify-end w-full sm:w-auto gap-4">
          ...
          <button
            ...
            disabled={isSaving}
            className="px-4 py-1.5 text-xs font-semibold rounded-lg border border-[#CBD5E1] hover:border-theme-text-primary text-theme-text-primary hover:bg-[#F1F5F9] dark:hover:bg-[#191817] transition-all disabled:opacity-50"
          >
