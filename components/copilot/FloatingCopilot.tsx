...
export function FloatingCopilot() {
  ...
  return (
    <>
      ...
      {open && (
        <div className="fixed bottom-24 right-6 z-[90] flex h-[min(600px,calc(100vh-130px))] w-[min(420px,calc(100vw-32px))] flex-col overflow-hidden rounded-2xl border border-theme-border-subtle bg-theme-bg-surface shadow-[0_30px_80px_-30px_rgba(24,22,15,0.6)]">
